...
class PersistentCartsRestApiToZedRequestClientBridgeTest extends Unit
{
    /**
     * @var \FondOfSpryker\Client\PersistentCartsRestApi\Dependency\Client\PersistentCartsRestApiToZedRequestClientBridge
     */
    protected $persistentCartsRestApiToZedRequestClientBridge;
    ...
    protected function _before(): void
    {
        ...
        $this->persistentCartsRestApiToZedRequestClientBridge = new PersistentCartsRestApiToZedRequestClientBridge(
    ...
    public function testCall(): void
    {
        ...
        $this->assertInstanceOf(
            ...
            $this->persistentCartsRestApiToZedRequestClientBridge->call(
                $this->url,
